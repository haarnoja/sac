...
class SimpleSampler(Sampler, Serializable):
    ...
    def sample(self):
        ...
        if 'distance_from_goal' in info:
            self._distance_from_goal = info['distance_from_goal']
        ...
        if terminal or self._path_length >= self._max_path_length:
            ...
            self._final_distance_from_goal = self._distance_from_goal
            self._path_return = 0
            self._n_episodes += 1
